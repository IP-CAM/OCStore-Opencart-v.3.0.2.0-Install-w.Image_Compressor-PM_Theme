...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
			...
			$data['importer'] = $product_info['importer'];
			$data['manufacturer_address'] = $product_info['manufacturer_address'];
          ...
          'thumb1220w' => $this->model_tool_image->resize($product_info['image'], 1220, 1220)
			...
			foreach ($results as $result) {
				$data['images'][] = array(
					...
					'thumb1220w' => $this->model_tool_image->resize($result['image'], 1220, 1220)
				);
			}
