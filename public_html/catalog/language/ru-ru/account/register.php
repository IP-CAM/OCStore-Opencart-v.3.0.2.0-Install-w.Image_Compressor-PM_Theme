...
// $_['text_account_already'] = 'Если Вы уже зарегистрированы, перейдите на страницу <a class="link" href="%s">входа в систему</a>.';
$_['text_account_already'] = 'Уже есть аккаунт? <a class="link" href="%s" style="margin-left: 1rem">Войти</a>';
...
$_['entry_address_1']      = 'Улица, дом, квартира, подъезд, этаж';
