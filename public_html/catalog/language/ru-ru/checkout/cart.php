...
$_['text_items']       							= 'Товаров в корзине: <b>%s</b>, на сумму: <b>%s</b>';
...
$_['error_stock']	= 'Товара нет в нужном количестве или он отсутствует на складе';
// $_['error_minimum']          					= 'Минимальное количество для заказа товара %s составляет %s!';
$_['error_minimum']	= 'Минимальное количество для заказа этого товара - %s';
