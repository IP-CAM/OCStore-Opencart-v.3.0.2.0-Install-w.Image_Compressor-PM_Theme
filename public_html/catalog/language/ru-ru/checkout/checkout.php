...
$_['cart__title'] = 'Товары в корзине';
$_['customer__title'] = '1. Контактные данные';
$_['shipping__title'] = '2. Способ получения';
$_['payment__title'] = '3. Способ оплаты';
$_['total__title'] = '4. Итоги заказа';
...
$_['error_telephone']                = 'Номер телефона должен содержать от 7 до 32 символов';
...
$_['error_no_shipping']              = 'Не найдены возможные варианты доставки в этот населенный пункт.<br>Свяжитесь с нами, и мы найдём решение проблемы.';
