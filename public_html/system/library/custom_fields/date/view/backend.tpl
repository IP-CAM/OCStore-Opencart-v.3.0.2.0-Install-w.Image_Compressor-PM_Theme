	<div class="form-group">
		...
		<div class="col-sm-3">
		  <div class="input-group date">
			<input type="text" name="custom_field[<?php echo $result['custom_fields_id']; ?>][<?php echo $language['language_id']; ?>][text]" value="<?php echo isset($data['custom_field'][$result['custom_fields_id']][$language['language_id']]['text'])?$data['custom_field'][$result['custom_fields_id']][$language['language_id']]['text']:''; ?>" placeholder="<?php echo $result['name']; ?>" data-date-format="<?php echo $result['data']['dateformat']; ?>" class="form-control" />
